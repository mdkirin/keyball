...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_universal(
        ...
        KC_LCTL  , KC_LGUI  , KC_LALT  , LT(1,KC_LNG1) , LT(2,KC_SPC), KC_LSFT, LT(2,KC_BSPC), LT(1,KC_SPC), _______, _______, _______, MO(4)
    ),
    ...
    [1] = LAYOUT_universal(
        ...
        KC_F9    , KC_F10   , KC_F11   , KC_F12   , _______   ,                           _______   , KC_BTN1   , _______   , KC_BTN2   , SCRL_MO  ,
        _______  , _______  , _______  , _______  , _______  , _______  ,      _______    , _______   , _______  , _______  , _______  , _______ 
    ),

    [2] = LAYOUT_universal(
        _______  , _______  , _______  , _______  , _______  ,                            S(KC_EQUAL)   , KC_7  , KC_8  , KC_9  , KC_BSPC  ,
        _______  , _______  , _______  , _______  , _______  ,                            KC_MINUS   , KC_4  , KC_5  , KC_6  , KC_QUOT  ,
